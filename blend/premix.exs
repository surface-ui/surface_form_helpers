...
# BLEND needs to be cleared to avoid conflict when using `path` or `github`
# deps that also use Blend like surface and surface_catalogue
System.delete_env("BLEND")
...
defmodule Blend.Premix.SurfaceForm do
  ...
  defp verify_requirements!(blend, blend_dep, mix_deps) do
    ...
    if mix_dep do
      ...
      Mix.shell().info("#{blend_app} not in your mix.exs deps")
    end
  end
end
